...
@interface CameraMan()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate>
...
- (void)record {
    ...
    [self.delegate cameraMan:self didChangeState: StateRecord];
}
...
- (void)pause {
    ...
    [self.delegate cameraMan:self didChangeState: StatePause];
}
...
- (void)stop {
    ...
    [self.delegate cameraMan:self didChangeState: StateStop];
}
...
- (void)resume {
    ...
    [self.delegate cameraMan:self didChangeState: StateResume];
}
...
-(void)initCapture{
    ...
    screenInput.cropRect = self.cropRect;
