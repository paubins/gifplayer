...
class GIFMakerViewController: NSViewController {
    // MARK: Fields
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.removeFrameCalled(sender:)),
                                               name: GIFMakerViewController.removeFrameNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.clickedImageView(sender:)),
                                               name: GIFMakerViewController.imageClickedNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.imageDraggedToImageView(sender:)),
                                               name: GIFMakerViewController.imageChangedNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.reloadImages),
                                               name: GIFMakerViewController.editingEndedNotificationName, object: nil)
        
        // UI events
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.loadGIFButtonClicked(sender:)),
                                               name: GIFMakerViewController.menuItemImportNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.exportGIFButtonClicked(sender:)),
                                               name: GIFMakerViewController.menuItemExportNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.addFrameButtonClicked(sender:)),
                                               name: GIFMakerViewController.menuItemAddFrameNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.previewButtonClicked(sender:)),
                                               name: GIFMakerViewController.menuItemPreviewNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.resetButtonClicked(sender:)),
                                               name: GIFMakerViewController.menuItemResetNotificationName, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.editButtonClicked(sender:)),
                                               name: GIFMakerViewController.menuItemEditNotificationName, object: nil)
        
        // GIFHandler events
        NotificationCenter.default.addObserver(self, selector: #selector(GIFMakerViewController.gifError(sender:)),
    ...
    override func viewDidAppear() {
        ...
        self.imageCollectionView.backgroundColor = GIFMakerViewController.backgroundColor
    ...
    @IBAction func loadGIFButtonClicked(sender: AnyObject?) {
        ...
        let filename:String = sender!.object as! String
        self.importGIF(from: URL(fileURLWithPath: filename))
    }
...
extension GIFMakerViewController: NSCollectionViewDelegate, NSCollectionViewDataSource {
