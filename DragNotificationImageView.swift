...
class DragNotificationImageView: NSImageView {
    ...
    override func draggingEnded(_ sender: NSDraggingInfo?) {
        NotificationCenter.default.post(name: GIFMakerViewController.imageChangedNotificationName, object: self)
    }
    ...
    override func mouseUp(with event: NSEvent) {
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: GIFMakerViewController.imageClickedNotificationName, object: self)
        }
    }
